...
<figure style="text-align: center;">
  ...
  <figcaption>Figure S6. </figcaption>
</figure>
```
...
<figure style="text-align: center;">
  ...
  <figcaption>Figure S7. </figcaption>
</figure>
```
...
```@raw html
<figure style="text-align: center;">
  <img src="../figures/figures8.png" style="width:80%">
...
```@raw html
<figure style="text-align: center;">
  <img src="../figures/figures9.png" style="width:80%">
...
```@raw html
<figure style="text-align: center;">
  <img src="../figures/figures11.png" style="width:80%">
